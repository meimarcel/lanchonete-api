...
@Component
public class ClientManagerAssembler implements RepresentationModelAssembler<Client, EntityModel<Client>>{
    ...
    public EntityModel<Client> toModel(Client entity) {
        return EntityModel.of(entity,
            ...
            linkTo(methodOn(ClientController.class).listClients(null)).withRel("list"),
            linkTo(methodOn(ClientController.class).createClient(null)).withRel("create"),
